      ...
      <div className='flex w-screen h-screen overflow-hidden'>
        <div className='bg-[#F3F4F5] md:w-[53.9%] h-screen flex flex-col md:px-[115px] px-10 pt-[42px] items-start justify-left text-left'>
          <div className='flex flex-col justify-center items-center w-full py-10 space-y-2'>
            ...
            {/* <h1 className='text-[#003338] text-[20px] py-3 font-bold'>Kirekeni Okwein</h1> */}
          </div>
          ...
          <form className='w-full py-6' onSubmit={handleSubmit}> 
            <div>
              ...
              <input type={"email"} className='w-full border bg-[#FAFAFA] rounded-[8px] py-3 px-4 mb-5 mt-1' value={email} onChange={handleChange} placeholder='Enter email' />
            </div>
            <button className='bg-[#005259] rounded-[8px] py-[13px] px-[10px] mt-4 text-[15px] w-full text-white' type='submit'>Continue</button>
          </form>
        </div>
